...
namespace Google2u
{
    ...
    "ck of all trades, master of none.", "Construction", "SafeCracking", "Sabotage", "Making", "Parties", "Biking", "Drugs", "Social", "Cars"));
			Rows.Add( new ProfilesRow("PROFILE_10", "Gordon", "Scotch, reading, cars", "Public transport, dogs, chick flicks", "Sabotage, medical", @"Hello all, my name is Gordon. To be quite honest, I’m not sure exactly why I have this profile; until recently I’d had no trouble finding jobs the old-fashioned way, but I suppose we all must evolve with the times, so here I am. I enjoy meeting new people, but I am quite shy at first and tend to hold my tongue until I know someone better.", "Sabotage", "Medical", "Occult", "Drugs", "Reading", "Cars", "Public Transport", "Dogs", "Sports"));
